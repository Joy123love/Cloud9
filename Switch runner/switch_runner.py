...
BG_ROOT = os.path.join('Switch runner', 'assets', 'backgrounds')
...
pygame.display.set_caption('Switch Runner - Prototype')
...
for layer in BG_LAYERS:
    img = pygame.image.load(os.path.join(BG_PATH, layer['file'])).convert_alpha()
...
CHARACTER_SHEET_PATH = os.path.join('Switch runner', 'assets', 'characters', 'animations', 'dude', 'Dude_Monster_Run_6.png')
CHARACTER_FRAMES = 6
...
# Hurt animation
HURT_SHEET_PATH = os.path.join('Switch runner', 'assets', 'characters', 'animations', 'dude', 'Dude_Monster_Hurt_4.png')
HURT_FRAMES = 4
...
# Death animation
DEATH_SHEET_PATH = os.path.join('Switch runner', 'assets', 'characters', 'animations', 'dude', 'Dude_Monster_Death_8.png')
DEATH_FRAMES = 8
...
PLAYER_IMAGE_PATH = os.path.join('Switch runner', 'assets', 'characters', 'select', 'Dude_Monster.png')
ENTITY_IMAGE_PATH = os.path.join('Switch runner', 'assets', 'characters', 'entity', 'download (1).jpeg')
...
# XP Coin Animation
XP_COIN_FRAMES = 6
XP_COIN_PATH = os.path.join('Switch runner', 'assets', 'objects', 'xp_coin')
xp_coin_images = []
...
BUBBLE_PATH = os.path.join('Switch runner', 'assets', 'objects', 'Bubble.png')
LIFE_PATH = os.path.join('Switch runner', 'assets', 'objects', 'Life.png')
...
SPIKES_PATH = os.path.join('Switch runner', 'assets', 'objects', 'Spikes.png')
SPIKES_FRAMES = 4
