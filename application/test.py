...
from PyQt6.QtWidgets import (
    ...
    QScrollArea, QFrame, QLineEdit, QTableWidget, QTableWidgetItem, QSizePolicy
)
...
class Dashboard(QWidget):
    def __init__(self):
        ...
        # Sidebar items
        leaderboard_item = QListWidgetItem(QIcon("podium.svg"), "Leaderboard")
        self.sidebar.addItem(leaderboard_item)
